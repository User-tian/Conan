...
class UnetDown(nn.Module):
    def __init__(self, hidden_size, n_layers, kernel_size, down_rates, channel_multiples=None, dropout=0.0,
                 is_BTC=True, constant_channels=False, add_attention=False):
    ...
    def forward(self, x, **kwargs):
        ...
        for i in range(self.n_layers):
            ...
            if self.add_attention and i==self.n_layers-1:
                skip_x = self.attns[i](skip_x)
...
class UnetUp(nn.Module):
    def __init__(self, hidden_size, n_layers, kernel_size, up_rates, channel_multiples=None, dropout=0.0,
                 is_BTC=True, constant_channels=False, use_skip_layer=False, skip_scale=1.0, add_attention=False):
...
class Unet(nn.Module):
    def __init__(self, hidden_size, down_layers, up_layers, kernel_size,
                 ...
                 is_BTC=True, constant_channels=False, mid_net=None, use_skip_layer=False, skip_scale=1.0, add_attention=False):
        ...
        self.down = UnetDown(hidden_size, down_layers, kernel_size, updown_rates,
                             channel_multiples, dropout, is_BTC, constant_channels, add_attention=add_attention)
        ...
        self.up = UnetUp(hidden_size, up_layers, kernel_size, updown_rates,
                         channel_multiples, dropout, is_BTC, constant_channels, use_skip_layer, skip_scale, add_attention=add_attention)
